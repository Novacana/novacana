...
const Hero = () => {
  ...
  return <section className="relative py-20 md:py-32 overflow-hidden bg-white dark:bg-gray-900">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
            <div className="inline-block mb-6 animate-fade-in">
              <img src="/lovable-uploads/66045f1f-4643-4ce0-9479-3d9a29387536.png" alt="Novacana" className="h-28 md:h-32 mx-auto lg:mx-0" onError={e => {
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight animate-fade-in" style={{
            animationDelay: "0.1s"
          }}>
              {t('hero.title')}<br />
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl mx-auto lg:mx-0 animate-fade-in" style={{
            animationDelay: "0.2s"
          }}>
              {t('hero.description')}
            </p>
            ...
            <div className="pt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in" style={{
            animationDelay: "0.4s"
          }}>
          ...
          <div className="w-full lg:w-1/2 mt-12 lg:mt-0 flex justify-center lg:justify-end animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
