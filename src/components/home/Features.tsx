...
const Features = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-purple-50 to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute right-0 bottom-1/4 w-48 h-48 bg-teal-200/10 dark:bg-teal-400/5 rounded-full animate-pulse-soft" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      <div className="container-content relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div 
              key={feature.title} 
              className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:shadow-primary/10 animate-fade-in"
              style={{ animationDelay: `${0.1 + feature.delay}s` }}
            >
